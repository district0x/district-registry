     ...
     [:section#main
      [:div.container
       [:div.box-wrap
        [:div.hero
         [:div.container
          [:div.page-title [:h1 "Privacy Policy"]]]]
        [:div.body-text
         [:div.container
          [:p "Effective: November 1st, 2019"]
          [:p "At The District Registry, we value the trust that you place in us when you give us personal information. We believe that privacy is more than an issue of compliance, and so we endeavor to manage personal information in accordance with our core value of respect for you and your privacy."]
          [:h3 "Does the Privacy Policy Apply to You?"]
          [:p "If you create an account with The District Registry, you will, upon registration, agree to our Privacy Policy."]
          [:h3 "Policy Summary"]
          [:p "The information you share with The District Registry allows us to provide you with the Services. You may choose not to provide personal data to us, but if you choose not to provide personal data, you may not be able to take advantage of the Services we offer."]
          [:p "The Policy includes:" [:br] [:br]]
          [:ul
          ...
          [:h3 "How long do we keep your personal information?"]
          ...
          [:h3 "Can you access, correct, or delete your personal information?"]
          ...
          [:h3 "Do we change our Privacy Policy?"]
