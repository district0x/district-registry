...
module.exports = function(callback) {
  ...
  for (i = 0; i < n; i++) {
    ...
    stakeBank.methods.calculatePurchaseReturn(currentTokenSupply, currentConnectorBalance, connectorWeight, depositAmount).call({from: '0x4c3F13898913F15F12F902d6480178484063A6Fb'}).then( (result) => {
